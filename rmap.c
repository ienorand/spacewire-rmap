...
{
    return rmap_is_instruction_unused_command_code(
        rmap_get_instruction(header));
}
...
{
    if (rmap_is_command(header)) {
        struct command_header_first_static_part *const first_static_part =
            header;
    ...
    const uint8_t initiator_logical_address)
{
    if (rmap_is_command(header)) {
        get_command_header_second_static_part(header)
            ->initiator_logical_address = initiator_logical_address;
        return;
    }
...
{
    if (rmap_is_command(header)) {
        const struct command_header_second_static_part
            *const second_static_part =
    ...
    const void *const command_header)
{
     ...
     */
    const uint8_t instruction = rmap_get_instruction(command_header) &
...
const char *rmap_status_text(const int status)
{
    ...
    case RMAP_NODE_INSUFFICIENT_DATA_WITH_EEP:
        return "RMAP_NODE_INSUFFICIENT_DATA_WITH_EEP";

    case RMAP_NODE_INVALID_KEY:
        return "RMAP_NODE_INVALID_KEY";

    case RMAP_NODE_COMMAND_NOT_IMPLEMENTED_OR_NOT_AUTHORIZED:
        return "RMAP_NODE_COMMAND_NOT_IMPLEMENTED_OR_NOT_AUTHORIZED";

    case RMAP_NODE_VERIFY_BUFFER_OVERRUN:
        return "RMAP_NODE_VERIFY_BUFFER_OVERRUN";

    case RMAP_NODE_MEMORY_ACCESS_ERROR:
        return "RMAP_NODE_MEMORY_ACCESS_ERROR";

    case RMAP_NODE_INVALID_REPLY:
        return "RMAP_NODE_INVALID_REPLY";

    case RMAP_NODE_PACKET_ERROR:
        return "RMAP_NODE_PACKET_ERROR";

    case RMAP_NODE_COMMAND_RECEIVED_BY_INITIATOR:
        return "RMAP_NODE_COMMAND_RECEIVED_BY_INITIATOR";

    case RMAP_NODE_REPLY_RECEIVED_BY_TARGET:
        return "RMAP_NODE_REPLY_RECEIVED_BY_TARGET";

    case RMAP_NODE_INVALID_TARGET_LOGICAL_ADDRESS:
        return "RMAP_NODE_INVALID_TARGET_LOGICAL_ADDRESS";

    case RMAP_NODE_ALLOCATION_FAILURE:
        return "RMAP_NODE_ALLOCATION_FAILURE";

    case RMAP_NODE_NO_TARGET_OR_INITIATOR:
        return "RMAP_NODE_NO_TARGET_OR_INITIATOR";

    case RMAP_NODE_SEND_REPLY_FAILURE:
        return "RMAP_NODE_SEND_REPLY_FAILURE";
